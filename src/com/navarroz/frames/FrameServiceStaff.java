...
public class FrameServiceStaff extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cboSection.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccionar", "Biblioteca", "Decanato", "Secretaría" }));
    ...
    public String getSection() {
        ...
        JOptionPane.showMessageDialog(null, "Debe seleccionar una sección");
        return "";
    }
    ...
    private void completTable() {
        model = new DefaultTableModel(new Object[][]{}, new Object[]{
            "DNI", "Nombre", "Apellido", "Edad", "E. Civil", "Sección", "Incorporación", "Despacho",});
